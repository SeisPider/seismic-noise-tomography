...
Extensions
-------------
`Description:`SeisPider extended this file matching local SEED data which users can't provide dataless Files and stationxml files.

`Usage:`Add a choice of USE_COMBINATION which let users to use stationxml which don't conclude
response information and RESP files to remove instrument response

* Use scripts of **[maratumba](https://github.com/maratumba/parsePZ)** to transfer PZ files decompressed from SEED using **[rdseed](http://ds.iris.edu/ds/nodes/dmc/manuals/rdseed/)**.

* Use `rdseed` to get RESP files 
